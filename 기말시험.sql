...
DROP TABLE KOPO_ST_채성은_FINAL1

SELECT * FROM KOPO_ST_채성은_FINAL1
...
LEFT JOIN KOPO_ST_김효관_FINAL2 B
ON 1=1
AND A.REGIONID = B.REGIONID
AND A.PRODUCT = B.PRODUCT; 

SELECT * FROM KOPO_ST_채성은_FINAL3
...
SELECT * FROM KOPO_ST_채성은_FINAL4
...
SELECT * FROM KOPO_ST_채성은_FINAL5
...
SELECT * FROM KOPO_ST_채성은_FINAL6  
